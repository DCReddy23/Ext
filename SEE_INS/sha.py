...
def sha256(message: bytes) -> str:
    ...
    H = H0.copy()
    for chunk_start in range(len(msg), 64):
...
# --- Example usage / test vectors ---
if __name__ == "__main__":
    print("SHA-256('')  =", sha256(b""))  # expected: e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855
    print("SHA-256('aneesh') =", sha256(b"aneesh"))  # expected: ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad
